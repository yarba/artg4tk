...
fcp -c /usr/bin/rcp ${TARFILE} ibtevnfsg4:/lfstev/g4p/yarba_j/g4studies/${CURRENTDATE}/analysis_${proc_level}_${beam}_IAEA
...
if [ ! -d "/lfstev/g4p/yarba_j/g4studies/${CURRENTDATE}/analysis_${proc_level}_${beam}_IAEA" ]; then
/bin/mkdir /lfstev/g4p/yarba_j/g4studies/${CURRENTDATE}/analysis_${proc_level}_${beam}_IAEA
fi
...
echo " submitting IAEA (Ishibashi) analysis for ${beam} of ${momz}GeV on ${target} " 
