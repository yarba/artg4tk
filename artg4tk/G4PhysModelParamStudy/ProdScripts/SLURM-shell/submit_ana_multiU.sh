...
sbatch -p amd32 -N1 -t 24:00:00 \
	--export="WORKDIR_TOP=${MRB_TOP},proc_level=FTFP,beam=piminus,pdgcode=-211,PATH2EVT=/lfstev/g4p/yarba_j/g4studies/06-13-19,NUniv=${nuni}" \
	-A g4p ana_HARP_multiU.sh
sbatch -p amd32 -N1 -t 24:00:00 \
	--export="WORKDIR_TOP=${MRB_TOP},proc_level=FTFP,beam=piplus,pdgcode=211,PATH2EVT=/lfstev/g4p/yarba_j/g4studies/06-13-19,NUniv=${nuni}" \
	-A g4p ana_HARP_multiU.sh
