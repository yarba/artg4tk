...
# 	--export="WORKDIR_TOP=${MRB_TOP},proc_level=FTFP,beam=proton,pdgcode=2212,PATH2EVT=/lustre1/g4/yarba_j/g4vmp-study/03-10-20,NUniv=${nuni}" \
...
#	slurm_multiU_master.sh ana_HARP_multiU_lq_1.sh
# pi-
#sbatch --ntasks-per-node=12 --time=23:00:00 --gres=gpu:0 -p gpu --qos=normal --account=g4 --exclusive  \
...
# proton
# sbatch --ntasks-per-node=1 --time=23:00:00 --gres=gpu:0 -p gpu --qos=normal --account=g4 --exclusive \
# 	--export="WORKDIR_TOP=${MRB_TOP},proc_level=FTFP,beam=proton,pdgcode=2212,PATH2EVT=/lustre1/g4/yarba_j/g4vmp-study/03-11-20,NUniv=${nuni}" \
#	slurm_multiU_master.sh ana_ITEP_multiU_lq_test.sh
# pi+
