...
fcp -c /usr/bin/rcp ${TARFILE} ibtevnfsg4:/lfstev/g4p/yarba_j/g4studies/${CURRENTDATE}/analysis_${proc_level}_${beam}_SASM6E
...
if [ ! -d "/lfstev/g4p/yarba_j/g4studies/${CURRENTDATE}/analysis_${proc_level}_${beam}_SASM6E" ]; then
/bin/mkdir /lfstev/g4p/yarba_j/g4studies/${CURRENTDATE}/analysis_${proc_level}_${beam}_SASM6E
fi
